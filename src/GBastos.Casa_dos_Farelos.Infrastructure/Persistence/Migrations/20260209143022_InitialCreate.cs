        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientePFId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ClientePJId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pedido", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Pedido_Pessoas_ClientePFId",
                        column: x => x.ClientePFId,
                        principalTable: "Pessoas",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Pedido_Pessoas_ClientePJId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Produtos_Pessoas_FornecedorId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItemCompra_Produtos_ProdutoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pedido_ClientePFId",
                table: "Pedido",
                column: "ClientePFId");

            migrationBuilder.CreateIndex(
                name: "IX_Pedido_ClientePJId",
                table: "Pedido",
                column: "ClientePJId");
